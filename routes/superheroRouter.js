...
superheroRouter.post('/', upload.array('heroImage'), addSuperpower, SuperheroController.createSuperhero);
...
superheroRouter.put('/:heroId', upload.array('heroImage'), addSuperpower, SuperheroController.updateSuperhero);
